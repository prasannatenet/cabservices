                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <x-admin-filter-bar :action="route('admin.cities.index')">
                        <div>
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="City, state, country..." class="block w-56 rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500">
                        </div>
                        <div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @forelse ($cities as $city)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $city->state }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $city->country }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $city->status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                {{ $city->status }}
                                            </span>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No cities found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
